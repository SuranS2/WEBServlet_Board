...
public class BoardController extends HttpServlet {
	...
	public BoardController() {
		super();
		this.service = BoardService.getInBoardService();
		this.replyService = ReplyService.getInBoardService();
	}
...
//							list >> 1 , 20
				...
				viewPage = "/WEB-INF/views/board/board_list.jsp";
			} catch (Exception e) {
			...
			try {
				...
				// 덧글 목록 보여주기
				List<Reply> replyList = replyService.replyList(idx); // 참조하는 글번호
			...
			viewPage = "/WEB-INF/views/board/board_content.jsp";
